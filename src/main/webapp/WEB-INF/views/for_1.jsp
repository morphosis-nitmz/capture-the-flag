      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='for_1'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID : FOR_1</h2></div>
...
<div class = "container card question-card">
  <h2 class= "text-center">
       The file given here is a captured network traffic from my laptop. Find out the name (ESSID) of the WiFi I connected.  
       
       <a href="http://res.cloudinary.com/dy94s9a2g/raw/upload/v1525614966/wifi.pcapng">File Link</a>
