      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='for_2'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID : FOR_2</h2></div>
...
Here is a QR. (https://sundayamizo.ga/ctf/files/qr.png)
 </div> 
 <br>
 <br>
