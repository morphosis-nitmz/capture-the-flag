      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='for_4'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID : FOR_4</h2></div>
...
<div class = "container card question-card">
  ...
  Here is a list of 1,000 server IPs. How many of them are active?
	(https://sundayamizo.ga/ctf/files/iplists.txt)
