      ...
      <%
        ...
        */
         // sending the question id to the check_ans_of_que
          String que_id = "math_add_large_number";
          String hint ="";
          int que_point = 00;
    	 ...
    	 try{
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='math_add_large_number';");
		    	  while(rs.next()){
            ...
            for (int i = 0; i < cookies.length; i++) {
			 ...
			 /*   try{
					    ...
					    while(rs_check.next())
					    {
					    	...
					    	if(db_que_id.equals("math_add_large_number"))
					    	{
					    		tri_1 = db_que_id;
					    		break;
					    	}
...
<div class = "container card question-card">
  <h2 class= "text-center">
      The link given below contains a file. The answer to this question is the summation of all the numbers there.
       <a class"btn btn-primary" href="https://sundayamizo.ga/ctf/files/very_large_num.txt">File</a>  </h2>
 </div> 
 <br>
 <br>
 <div class = "container card solution-card">
      ...
      <c:set var="que"  value="${math_add_large_number}"/>
 ...
 <%
 } // end of the cokkies if condtion
         else
         {
        	 out.println("<div class = 'container' style='background-color:red'> <h2>No Cookies Found, Do the Sign In Again</h2></div>");
         }
   %>
</body>
</html>