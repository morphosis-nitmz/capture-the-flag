      ...
      <%
        ...
        */
         // sending the question id to the check_ans_of_que
          String que_id = "math_add_scrabbled_noise_number";
          String hint ="";
          int que_point = 00;
    	 ...
    	 try{
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='math_add_scrabbled_noise_number';");
		    	  while(rs.next()){
 ...
 // extraction the email
  ...
  /*  try{
		    ...
		    while(rs_check.next())
		    {
		    	...
		    	if(db_que_id.equals("math_add_scrabbled_noise_number"))
		    	{
		    		tri_1 = db_que_id;
		    		break;
		    	}
...
<div class = "container card question-card">
  <h2 class= "text-center">
       The link given below contains a file. The answer to this question is the summation of all the numbers there. You may have to do a little preprocessing before you can solve!!
       <a class"btn btn-primary" href="https://sundayamizo.ga/ctf/files/very_large_number_scrabbled_with_noise.txt">File</a>  </h2>
 ...
 <div class = "container card solution-card">
      ...
      <c:set var="que"  value="${math_add_scrabbled_noise_number}"/>
