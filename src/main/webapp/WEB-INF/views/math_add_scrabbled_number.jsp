      ...
      <%
        ...
        */
         // sending the question id to the check_ans_of_que
          String que_id = "math_add_scrabbled_number";
          String hint ="";
          int que_point = 00;
    	 ...
    	 try{
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='math_add_scrabbled_number';");
		    	  while(rs.next()){
 ...
 // extraction the email
  ...
  /*  try{
		    ...
		    while(rs_check.next())
		    {
		    	...
		    	if(db_que_id.equals("math_add_scrabbled_number"))
		    	{
		    		tri_1 = db_que_id;
		    		break;
		    	}
...
<div class = "container card question-card">
  <h2 class= "text-center">
       ...
       <a class"btn btn-primary" href="https://sundayamizo.ga/ctf/files/very_large_scrabbled_num.txt">File</a>  </h2>
        </h2>
 </div> 
 <br>
 <br>
 <div class = "container card solution-card">
      ...
      <c:set var="que"  value="${math_add_scrabbled_number}"/>
