      ...
      <%
        ...
        */
         // sending the question id to the check_ans_of_que
          String que_id = "math_add_simple_number";
          String hint="";
          int que_point = 00;
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='math_add_simple_number'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       ...
       <a class"btn btn-primary" href="https://sundayamizo.ga/ctf/files/simple_num.txt">File</a>
  </h2>
 </div> 
 <br>
 <br>
