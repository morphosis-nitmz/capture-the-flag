      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='misc_1'");
  ...
  <h2 class= "text-center">
      <table class = "table table-bordered">
        <tr>
            ...
            <td>3</td>
            <td>6</td>
            <td>One number is correct but wrongly placed</td>
        </tr>
        <tr>
            <td>0</td>
            <td>6</td>
            <td>5</td>
            <td>One number is correct and correctly placed</td>
        </tr>
         <tr>
            <td>3</td>
            <td>7</td>
            <td>2</td>
            <td>Two numbers are correct but wrongly placed</td>
        </tr>
        <tr>
            <td>6</td>
            <td>4</td>
            <td>7</td>
            <td>No numbers are correct</td>
        </tr>
         <tr>
            <td>5</td>
            <td>2</td>
