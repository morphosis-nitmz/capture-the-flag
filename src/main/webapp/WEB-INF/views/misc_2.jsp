      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='misc_2'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       Alright, here is an image. The flag is hidden INSIDE it. <a href="https://sundayamizo.ga/ctf/files/cat.jpg">See Image Here!</a>
         </h2>
 </div> 
 <br>
 <br>
