      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='parse_1'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
    ...
    The answer to this puzzle is the top antivirus engine that produced the highest percentage of positives.
    ...
    NOTE: The answer should be submitted with no spaces and all lower case letter.
    vt_minute_output.tar.bz2

    nb: this question is taken  from NeverLAN CTF. specially included for coders.   </h2>
  <a href="https://sundayamizo.ga/ctf/files/vt_minute_output.tar.bz2"><button>Download File</button></a>
 </div> 
 <br>
 <br>
