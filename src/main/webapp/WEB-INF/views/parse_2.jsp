      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='parse_2'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
   ...
   The answer to this question is the name of the engine that produced the 3rd highest percentage of positives from the previous question.
   </h2>
