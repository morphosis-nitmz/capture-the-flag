      ...
      <%
         ...
         if( cookies != null ) {
            ...
            for (int i = 0; i < cookies.length; i++) {
               ...
               if(cookie.getName().equals("username"))
               {
            	   ...
            	   out.at.jpgprintln("New Table name   :  "  + table_name + "\n");
               }
            }
         } else {
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='recon_1'");
...
<div class = "container card question-card">
  ...
  <h2 class= "text-center">
       kent@krypton used Instagram alot... you may wanna check :D
         </h2>
 </div> 
 <br>
 <br>
