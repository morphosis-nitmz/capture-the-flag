      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='recon_2'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
   kent@krypton is having something hidden in his website.... find his website... find the hidden message....
         </h2>
 </div> 
 <br>
 <br>
