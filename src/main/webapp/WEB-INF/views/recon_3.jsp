      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='recon_3'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       this section "recon" is all about how much can you find out about the author...
 so... used the internet...ask your seniors.. ask anyone except kent@krypton.. try to answer this one..
 "did you know what are the names of the projects started by kent@krypton?"  </h2>
 </div> 
 <br>
 <br>
