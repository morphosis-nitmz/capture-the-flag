...
}My name contains the square of 8. I am an encryption algorithm. I always put "=" or "==" at the end of my encrypted data. What am I?
.container:hover{
opacity:0.95;
}
</style>
      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_3'");
