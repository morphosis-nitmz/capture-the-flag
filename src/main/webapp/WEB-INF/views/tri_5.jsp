      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_5'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       What is the name of that ransomeware that breakout in mid 2017?  </h2>
 </div> 
 <br>
 <br>
