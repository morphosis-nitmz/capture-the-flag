      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_6'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
   Let's check your skill. When will Facebook (https://facebook.com) SSL certificate expire?  </h2>
 </div> 
 <br>
 <br>
