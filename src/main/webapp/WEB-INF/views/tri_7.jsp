      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_7'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
      You may have heard of CSRF. Due to insufficiency, some alternatives are used. The answer is one of the alternatives. </h2>
 </div> 
 <br>
 <br>
