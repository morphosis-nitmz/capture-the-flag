      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_8'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID : TRI_8</h2></div>
...
<div class = "container card question-card">
  <h2 class= "text-center">
       !
       What is the filename of the decryptor for WannaCry ransomeware?
         </h2>
 </div> 
 <br>
 <br>
