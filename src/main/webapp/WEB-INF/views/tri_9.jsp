      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_9'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       What organisation issued SSL certificate for Twitter (https://twitter.com)
         </h2>
 </div> 
 <br>
 <br>
