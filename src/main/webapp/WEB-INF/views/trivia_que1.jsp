      ...
      <%
        ...
        */
        ...
        String hint ="";
    	 ...
    	 try{
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='tri_1';");
		    	  while(rs.next()){
...
<div class = "container card question-card">
 ...
 <div class = "container card solution-card">
      ...
      <c:set var="que"  value="${tri_1}"/>
     
     <c:if test="${fn:length(que) == 0}" >
    
       <form action="${pageContext.request.contextPath}/sol_trivia_que1" method="GET" class = "form">
