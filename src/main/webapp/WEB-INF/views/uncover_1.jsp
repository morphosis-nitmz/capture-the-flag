      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_1'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       this one is very simple...one of the simplest encryption...  
   question: uzr0dymfuaz_ue_b0iqd_wz0i_k0gd_mphqdemdk  </h2>
 </div> 
 <br>
 <br>
