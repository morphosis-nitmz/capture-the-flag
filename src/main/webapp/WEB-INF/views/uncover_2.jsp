      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_2'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       there are h*ll lot of encryption algo, Use two of the simplest algorithm and you will see the flag... 
   question: dV9kcWJxbWZfdXpyMGR5bWZ1YXpfdWVfYjBpcWRfd3owaV9rMGdkX21waHFkZW1kaw==  </h2>
 </div> 
 <br>
 <br>
