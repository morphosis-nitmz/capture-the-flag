      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_3'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       <pre>the most famous detective of all time (will not mention his name) received this message..
   	 SOMNEHCCGTEKOTYRIMOOLAIGU

   he can not find out the meaning... so.. i helped him out...
   try to solve it yourself or visit his website... you'll find the answer there.. 
   and btw, the flag should not contain space and uppercase letter...a grid may help you solve if you cannot find the website...</pre>  </h2>
 </div> 
 <br>
 <br>
