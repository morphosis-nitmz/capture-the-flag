      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_4'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
     Decode this morse Code (code inside the quotes)
