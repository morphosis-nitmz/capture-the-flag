      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_5'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       ...
       abhi is searching for the number but he got the roman number so decode this roman for the abhi.
       
       Romans : CVI CXI CXV CI CXII CIV XCVIII CXVI XLIX LII CI CI XLVIII XLVIII LI
