      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_6'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
      <!--  How many images in morphoCTF ?  -->
     Abhi is not good in counting. so count the images in the MorphoCTF website home page only!!.
        </h2>
 </div> 
 <br>
 <br>
