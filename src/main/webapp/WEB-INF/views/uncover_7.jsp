      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='uncover_7'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
      Here is a message: uxoax pfkmf aifka qnie <br> Decode This </h2>
 </div> 
 <br>
 <br>
