      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='web_1'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
     Go to the link. It contains the hint. (https://sundayamizo.ga/ctf/ctf.php) </h2>
 </div> 
 <br>
 <br>
