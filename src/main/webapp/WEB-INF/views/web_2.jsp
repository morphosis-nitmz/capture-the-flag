      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='web_2'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID :WEB_2</h2></div>
...
<div class = "container card question-card">
  <h2 class= "text-center">
       The answer is 3 doors away. Go here. (https://sundayamizo.ga/ctf/c.php)  </h2>
 </div> 
 <br>
 <br>
