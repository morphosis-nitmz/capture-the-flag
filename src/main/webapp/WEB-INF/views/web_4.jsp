      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='web_4'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
       abhi Subdirectory has the flag !!   </h2>
 </div> 
 <br>
 <br>
