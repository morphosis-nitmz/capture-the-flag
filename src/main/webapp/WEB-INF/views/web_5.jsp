      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='web_5'");
...
<div class = "container card question-card">
  <h2 class= "text-center">
      What is the name of the cookie for MorphoCTF?</h2>
 </div> 
 <br>
 <br>
