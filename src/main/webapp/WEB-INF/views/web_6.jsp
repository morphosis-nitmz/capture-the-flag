      ...
      <%
        ...
        */
    	 ...
    	 try{
    		 ...
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='web_6'");
...
<div class = "container card question-head-card text-center">
     ...
     <div class = "row">
        <div class = "col-md-4"><h2 class= "text-center">Question ID : WEB_6</h2></div>
...
<div class = "container card question-card">
  <h2 class= "text-center">
       I am logged in. Find me here - https://sundayamizo.ga/ctf/cw4.php
</h2>
 </div> 
 <br>
 <br>
