      ...
      <%
        ...
        */
         // sending the question id to the check_ans_of_que
          String que_id = "maths_add_simple_numbers";
          String hint ="";
          int que_point = 00;
    	 ...
    	 try{
    		 ResultSet rs = stmt.executeQuery("select * from question_points where que_id='maths_add_simple_numbers';");
		    	  while(rs.next()){
 ...
 // extraction the email
   ...
   try{
		    ...
		    while(rs_check.next())
		    {
		    	...
		    	if(db_que_id.equals("maths_add_simple_numbers"))
		    	{
		    		tri_1 = db_que_id;
		    		break;
		    	}
...
<div class = "container card question-card">
 ...
 <div class = "container card solution-card">
      ...
      <c:set var="que"  value="${maths_add_simple_numbers}"/>
